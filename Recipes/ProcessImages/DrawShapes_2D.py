...
def run(params):
    ...
    def reset_gui_defaults():
        gui.shape_center_X_c.value = image_center[1]
        gui.shape_center_Y_c.value = image_center[0]
        gui.shape_radius_c.value = image_center[1]
        gui.shape_small_radius_c.value = image_center[0]
    ...
    selected_position = float(gui.shape_center_Y_c.value), float(gui.shape_center_X_c.value)        # Y, X
    selected_radius = gui.shape_radius_c.value
    selected_small_radius = gui.shape_small_radius_c.value
